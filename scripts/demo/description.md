# MAP CanvasMeet — feature description (clip & social copy)

> **Scenario:** 3 nhân vật giả định cùng review một mặt bằng kiến trúc trong thời gian thực — Luân (VN, kiến trúc sư), Dojin (KR, kỹ sư), Elon (EN, chủ đầu tư). Mỗi người gõ tiếng của mình, đọc bản dịch tiếng mình. Một bản vẽ. Một cuộc họp. Ba ngôn ngữ.
...
## 2. Tagline (2 dòng) — dùng cho thumbnail / banner
...
>
> Điểm khác biệt: cuộc họp **không bị giới hạn bởi ngôn ngữ**. Tiếng Việt, Hàn, Anh được dịch tự động qua **chat**, **note trên canvas**, **note trên PDF**, và **transcript live** — mỗi người đọc đúng ngôn ngữ của mình mà không cần ai dừng lại phiên dịch. Khi họp xong, **AI tự tóm tắt** từ log chat + transcript thành biên bản với quyết định và việc cần làm — không ai phải gõ minutes.
>
...
>
> What sets it apart: the meeting **isn't bound by language**. Vietnamese, Korean, and English are translated automatically across **chat**, **canvas notes**, **PDF annotations**, and **live transcript** — each person reads in their own language without anyone stopping to translate. When the meeting ends, **AI summarizes** from the chat and transcript logs into a record of decisions and action items — no one types up minutes.
>
> This demo shows three fictional teammates reviewing the same villa floor plan across three working languages.
...
(0:06) Ba người: Luân, kiến trúc sư người Việt.
Dojin, kỹ sư bên văn phòng Seoul.
Elon, chủ đầu tư người Mỹ.

(0:14) Cùng một bản vẽ — mỗi người zoom vào chi tiết riêng,
khoanh chỗ cần sửa, ghi chú trên cả PDF lẫn hình ảnh.

(0:22) Tiếng Việt, Hàn, Anh — dịch ngay trong chat và transcript.

(0:28) Một bản vẽ. Một cuộc họp. Ba ngôn ngữ.
```
...
(0:06) Three people: Luân, an architect in Vietnam.
Dojin, an engineer from the Seoul office.
Elon, the client.

(0:14) One drawing — each zooms into their own detail,
marks up what needs fixing, annotates PDFs and images alike.

(0:22) Vietnamese, Korean, English — translated live across chat and transcript.

(0:28) One canvas. One meeting. Every language.
```
...
- **PDF viewer trên canvas**:
  ...
  - Page navigation độc lập per anchor — Luân ở trang 1, Dojin ở trang 5 cùng lúc
  - Ghi chú trực tiếp lên trang (canvas text element bên cạnh)
  - Khoanh revision cloud quanh chi tiết
  - Mỗi note + mark đều có nút Dịch inline (xem mục Communication)
- **Revision cloud** + arrow + ghi chú liên kết (3 elements grouped, di chuyển cùng nhau)
