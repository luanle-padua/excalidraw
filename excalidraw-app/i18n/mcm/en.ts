...
export const en: Widened<typeof vi> = {
  ...
  header: {
    ...
    meetingTimeTitle: "When the meeting took place",
    layout: "Layout",
    present: "Present",
    presentUnsupported:
  ...
  settings: {
    ...
    tabPrivacy: "Privacy",
    accountNote:
      "The organisation details below are system-managed — read-only here.",
    accountError: "Couldn't load account info. Showing your sign-in session.",
    email: "Email",
    titleField: "Title (직급)",
    division: "Division",
    role: "Role",
    ...
    pwMismatch: "Confirmation doesn't match.",
    pwWrongCurrent: "Current password is incorrect.",
    pwUpdateFailed: "Couldn't change password. Try again.",
    pwUnavailable: "Password change isn't available for this account.",
    signOut: "Sign out",
    prefAppearance: "Appearance",
    uiLanguage: "Interface language",
    uiLanguageHint: "Applies to the whole app interface.",
    theme: "Theme",
    themeLight: "Light",
    themeDark: "Dark",
    themeSystem: "System",
    prefTranslation: "Translation",
    chatTranslate: "Translate chat messages",
    chatTranslateHint: "Auto-translate messages into your language.",
    prefStt: "Speech-to-text",
    micStt: "Enable mic for STT",
    micSttHint: "When on, your mic is transcribed live.",
    spokenLanguage: "Language you speak",
    spokenLanguageHint: "The language Deepgram transcribes your mic in.",
    sttTranslate: "Translate transcript segments",
    sttTranslateHint: "Translate each finalised segment into your language.",
    panelStyle: "Transcript panel style",
    panelFull: "Full",
    ...
    loading: "Loading…",
    untitled: "Untitled",
    micConsent: "Microphone consent",
    micConsentLabel: "Allow mic transcription (Deepgram)",
    micConsentHint:
      "When on, your mic audio is sent to Deepgram for live transcription. Off = nothing is sent.",
    dataNoteTitle: "What we store about you",
    dataNoteBody:
      "We store your profile (name, company, avatar), a log of meetings you join, files you upload, and transcripts while you have STT on. Interface preferences (language, theme, captions) are kept on this device only.",
  },
  ...
  cloudRecording: {
    ...
    contentAudio: "Audio",
    contentScreen: "Screen share",
    screenHint:
      "The canvas reopens any time, so it isn't recorded. When someone is sharing their screen it's captured live; otherwise the file is audio-only.",
    joinHint: "Join the audio call first to record.",
    willRecord: "Will record: {what}",
    pickContent: "Pick at least audio to record.",
    uploadFailed: "Recording saved but upload failed",
    startFailed: "Couldn't start recording",
  ...
  screenShare: {
    ...
    surfaceGeneric: "screen",
    everyoneSees: "Everyone can see this",
  ...
  // ---------------- Meeting Package ----------------------------------
  pkg: {
    create: "Create recap package",
    builderTitle: "Meeting recap",
    builderSubtitle:
      "Pick the content and files to package and share. The original meeting stays untouched.",
    titleLabel: "Package title",
    titlePlaceholder: "e.g. Design review — week 24 recap",
    summaryLabel: "Summary (editable)",
    summaryPlaceholder: "Summarise what to share…",
    ...
    audienceList: "Email list",
    audienceMeetingHint: "People invited to / who attended this meeting.",
    audienceProjectHint: "Every member of the project.",
