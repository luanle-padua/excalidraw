...
## Prod state
- **Pages `map-canvasm` = `ce3f75d8`** (https://map-canvasm.pages.dev) · **Worker `mcm-storage` = `466b11a6`** · D1 migrations **0038**. Recent: `ab2a67a0` (#23/#24 per-speaker rec+lock), `eb394afb` (#25 mic deadlock), `07774411` (#26/#27 end-for-all teardown), `999dd6f8`+`1dd2993e` (**#28 unified replay** — ms-clock player + who-spoke-when speaker lanes + play-along chooser canvas/audio/screen). Migration apply: MANUAL `cd worker && npx wrangler d1 execute mcm-db --remote --file=./schema/00NN_*.sql -y`.
