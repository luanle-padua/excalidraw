...
// mcm: the upstream HelpDialog header linked out to Excalidraw's own docs/blog/
// GitHub/YouTube. Those are external brand surfaces we don't own, so the header
// is dropped entirely — this dialog now shows only the keyboard-shortcut
// reference below.
